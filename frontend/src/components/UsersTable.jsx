                ...
                >
                  ...
                  <td className="px-9 py-3 text-end">
                    <div className="flex items-center justify-end space-x-2">
                      <IconButton className="bg-green-500 text-white hover:bg-green-600 relative group" onClick={() => navigate(`edit/${user.id}`)} >
                        <svg
                      ...
                      <IconButton className="bg-white border border-gray text-slate-600 rounded-md hover:bg-red-500 hover:border-danger hover:text-white relative group">
                      <svg
                            className="-translate-y-px"
                            width="14"
                            height="14"
