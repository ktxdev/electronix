...
function Table({columnDisplayNames = [], columnFieldNames = [], datd}) {
  return (
          ...
          <table className="w-full text-base text-left text-gray-500">
            <thead className="bg-white">
              <tr className="border-b border-gray6 text-tiny">
                {
                    columnDisplayNames.map(displayName => <th key={displayName} scope="col" className="pr-8 py-3 text-tiny text-center uppercase font-semibold"> {displayName}</th>)
                }
                <th
                  scope="col"
